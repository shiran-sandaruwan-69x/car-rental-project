...
function loadAllUnverifiedCustomers() {
    ...
    $('#tblCusBody').empty();
    $.ajax({
        url: 'http://localhost:8080/Car_Rental/api/v1/customer',
        method: 'GET',
...
function deleteCar1() {
    ...
    if (confirm("Are you sure to delete this Car")){
        $.ajax({
            url:'http://localhost:8080/Car_Rental/api/v1/car?'+$.param({id:chec}),
            type:'DELETE',
            dataType:'json',
...
$('#saveDriver').click(() => {
    ...
    $.ajax({
        method: "POST",
        url: "http://localhost:8080/Car_Rental/api/v1/driver",
        data: JSON.stringify({
            "driverID": "",
            "name": dname,
            "contactNo": dcontact,
...
function deleteDiver() {
    ...
    if (confirm("Are you sure to delete this Car")){
        $.ajax({
            url:'http://localhost:8080/Car_Rental/api/v1/driver?'+$.param({id:cID}),
            type:'DELETE',
            dataType:'json',
            contentType:'application/json',
            success:function (resp) {
...
function loadAllOrders() {
    $('#tblOrdersBody').empty();
    $.ajax({
        url: 'http://localhost:8080/Car_Rental/api/v1/booking',
        method: 'GET',
        success: function (res) {
            let values = res.data;
            for (i in values) {
...
function placePayment() {
    ...
    $.ajax({
        method: "POST",
        url: "http://localhost:8080/Car_Rental/api/v1/payment",
        data:JSON.stringify({
            "paymentID":"",
            "cusId":cusid,
            "carId": carId,
