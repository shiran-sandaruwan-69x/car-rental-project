...
function loadSearchCars() {
    ...
    $('#tblCarSerch').empty();
    $.ajax({
        url: 'http://localhost:8080/Car_Rental/api/v1/car/type/'+tp,
        method: 'GET',
        success: function (res) {
            let values = res.data;
            for (i in values) {
...
$('#placeorder').click(function () {
    ...
    $.ajax({
        method: 'GET',
        url: 'http://localhost:8080/Car_Rental/api/v1/customer/'+cusID,
        async: false,
        success: function (res) {
            customer = res.data;
        }
    ...
    $.ajax({
        method: 'GET',
        url: 'http://localhost:8080/Car_Rental/api/v1/car/'+carID,
        async: false,
        success: function (res) {
            car = res.data;
        }
    ...
    $.ajax({
        method: 'GET',
        url: 'http://localhost:8080/Car_Rental/api/v1/driver/stat/available',
        async: false,
        success: function (res) {
            driver = res.data;
        }
